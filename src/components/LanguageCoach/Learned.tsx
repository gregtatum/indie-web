  ...
  return (
    <div className="learned AppScroll" key={languageCode}>
      <p className="learnedIntro">
        ...
        de-duplicate words that may vary on tense or on verb ending, the learned
        word list is stored as the root of the word. This is not always perfect,
        as the word root is generated from a dictionary.
      </p>
      <p>
        <button
          type="button"
